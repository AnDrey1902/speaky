...
import { SpeakyHarness } from '../electron/harness/index';
...
async function runTestSuite() {
  ...
  const harness = new SpeakyHarness();

  await test('Execution', 'Проверка сборки и инициализации фасада SpeakyHarness', () => {
