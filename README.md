...
| :--- | :--- | :--- |
| **Windows 10 / 11** | [**Скачать Speaky (speaky-setup-1.0.4.exe)**](https://github.com/anufriev163/speaking/releases/download/v1.0.4/speaky-setup-1.0.4.exe) | Запустите инсталлятор и следуйте подсказкам мастера установки. |
