# 🎙️ Speaky — голосовой ввод нового поколения для Windows и macOS
...
[![Скачать для Windows](https://img.shields.io/badge/Скачать-Windows%20(exe)-success?logo=windows)](https://github.com/anufriev163/speaking/releases/download/v1.0.3/speaky-setup-1.0.3.exe)
[![Скачать для macOS](https://img.shields.io/badge/Скачать-macOS%20(dmg)-black?logo=apple)](https://github.com/anufriev163/speaking/releases/download/v1.0.3/speaky-1.0.3.dmg)
...
| :--- | :--- | :--- |
| **Windows 10 / 11** | [**Скачать Speaky (speaky-setup-1.0.3.exe)**](https://github.com/anufriev163/speaking/releases/download/v1.0.3/speaky-setup-1.0.3.exe) | Запустите инсталлятор и следуйте подсказкам мастера установки. |
| **macOS (Apple Silicon & Intel)** | [**Скачать DMG (speaky-1.0.3.dmg)**](https://github.com/anufriev163/speaking/releases/download/v1.0.3/speaky-1.0.3.dmg) | Откройте DMG и перетащите «speaky» в папку Applications. |
