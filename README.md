...
[![Скачать для Windows](https://img.shields.io/badge/Скачать-Windows%20(exe)-success?logo=windows)](https://github.com/anufriev163/speaking/releases/latest/download/speaky-setup-1.0.1.exe)
...
| :--- | :--- | :--- |
| **Windows 10 / 11** | [**Скачать Speaky (speaky-setup-1.0.1.exe)**](https://github.com/anufriev163/speaking/releases/latest/download/speaky-setup-1.0.1.exe) | Запустите инсталлятор и следуйте подсказкам мастера установки. |
