...
[![Скачать для Windows](https://img.shields.io/badge/Скачать-Windows%20(exe)-success?logo=windows)](https://github.com/anufriev163/speaking/releases/latest/download/speaky.exe)
...
| :--- | :--- | :--- |
| **Windows 10 / 11** | [**Скачать speaky.exe**](https://github.com/anufriev163/speaking/releases/latest/download/speaky.exe) | Запустите инсталлятор и следуйте подсказкам мастера установки. |
